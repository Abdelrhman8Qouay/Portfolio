...
// get all skills from json ( createSkill ) and put it
createSkill("jsonFiles/skills.json", "skill");

// get all projects from json ( createSkill ) and put it
createSkill("jsonFiles/projects.json", "project");


async function createSkill(url, forE) {
    try {
